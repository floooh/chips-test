...
UTEST(m6502x, LDA) {
    ...
    // immediate
    T(2 == step()); T(R(A) == 0x00); T(tf(M6502X_ZF));
    T(2 == step()); T(R(A) == 0x01); T(tf(0));
    T(2 == step()); T(R(A) == 0x00); T(tf(M6502X_ZF));
    T(2 == step()); T(R(A) == 0x80); T(tf(M6502X_NF));

    // zero page
    T(3 == step()); T(R(A) == 0x01); T(tf(0));
    T(3 == step()); T(R(A) == 0x00); T(tf(M6502X_ZF));
    T(3 == step()); T(R(A) == 0x80); T(tf(M6502X_NF));
    ...
    T(4 == step()); T(R(A) == 0xAA); T(tf(M6502X_NF));
    ...
    T(6 == step()); T(R(A) == 0x89); T(tf(M6502X_NF));
    T(6 == step()); T(R(A) == 0x8A); T(tf(M6502X_NF));

    // indirect,Y (both 6 cycles because page boundary crossed)
    w8(0x1324, 0x98); w8(0x4411, 0xA8);
    T(6 == step()); T(R(A) == 0x98); T(tf(M6502X_NF));
    T(6 == step()); T(R(A) == 0xA8); T(tf(M6502X_NF));
}
...
UTEST(m6502x, LDX) {
    ...
    // immediate
    T(2 == step()); T(R(X) == 0x00); (tf(M6502X_ZF));
    T(2 == step()); T(R(X) == 0x01); (tf(0));
    T(2 == step()); T(R(X) == 0x00); (tf(M6502X_ZF));
    T(2 == step()); T(R(X) == 0x80); (tf(M6502X_NF));

    // zero page
    T(3 == step()); T(R(X) == 0x01); T(tf(0));
    T(3 == step()); T(R(X) == 0x00); T(tf(M6502X_ZF));
    T(3 == step()); T(R(X) == 0x80); T(tf(M6502X_NF));
    ...
    T(4 == step()); T(R(X) == 0xAA); T(tf(M6502X_NF));
...
UTEST(m6502x, LDY) {
    ...
    // immediate
    T(2 == step()); T(R(Y) == 0x00); T(tf(M6502X_ZF));
    T(2 == step()); T(R(Y) == 0x01); T(tf(0));
    T(2 == step()); T(R(Y) == 0x00); T(tf(M6502X_ZF));
    T(2 == step()); T(R(Y) == 0x80); T(tf(M6502X_NF));

    // zero page
    T(3 == step()); T(R(Y) == 0x01); T(tf(0));
    T(3 == step()); T(R(Y) == 0x00); T(tf(M6502X_ZF));
    T(3 == step()); T(R(Y) == 0x80); T(tf(M6502X_NF));
    ...
    // zero page,Y
    T(2 == step()); T(R(X) == 0x0F); T(tf(0));
    T(4 == step()); T(R(Y) == 0xAA); T(tf(M6502X_NF));
...
UTEST(m6502x, TAX_TXA) {
    ...
    T(2 == step()); T(R(X) == 0x00); T(tf(M6502X_ZF));
    T(2 == step()); T(R(A) == 0xF0); T(tf(M6502X_NF));
    T(2 == step()); T(R(A) == 0x00); T(tf(M6502X_ZF));
    T(2 == step()); T(R(A) == 0xF0); T(tf(M6502X_NF));
    T(2 == step()); T(R(X) == 0x00); T(tf(M6502X_ZF));
    T(2 == step()); T(R(X) == 0xF0); T(tf(M6502X_NF));
...
UTEST(m6502x, DEX_INX_DEY_INY) {
    ...
    T(2 == step()); T(R(X) == 0x00); T(tf(M6502X_ZF));
    T(2 == step()); T(R(X) == 0xFF); T(tf(M6502X_NF));
    T(2 == step()); T(R(X) == 0x00); T(tf(M6502X_ZF));
    T(2 == step()); T(R(X) == 0x01); T(tf(0));
    T(2 == step()); T(R(Y) == 0x01); T(tf(0));
    T(2 == step()); T(R(Y) == 0x00); T(tf(M6502X_ZF));
    T(2 == step()); T(R(Y) == 0xFF); T(tf(M6502X_NF));
    T(2 == step()); T(R(Y) == 0x00); T(tf(M6502X_ZF));
    T(2 == step()); T(R(Y) == 0x01); T(tf(0));
}

UTEST(m6502x, TXS_TSX) {
    init();
    uint8_t prog[] = {
        0xA2, 0xAA,     // LDX #$AA
        0xA9, 0x00,     // LDA #$00
    ...
    T(2 == step()); T(R(X) == 0xAA); T(tf(M6502X_NF));
    T(2 == step()); T(R(A) == 0x00); T(tf(M6502X_ZF));
    T(2 == step()); T(R(S) == 0xAA); T(tf(M6502X_ZF));
    T(2 == step()); T(R(X) == 0x00); T(tf(M6502X_ZF));
    T(2 == step()); T(R(X) == 0xAA); T(tf(M6502X_NF));
}
...
UTEST(m6502x, AND) {
    ...
    T(2 == step()); T(R(A) == 0xFF); T(tf(M6502X_NF));
    T(2 == step()); T(R(X) == 0x01); T(tf(0));
    T(2 == step()); T(R(Y) == 0x02); T(tf(0));
    T(2 == step()); T(R(A) == 0xFF); T(tf(M6502X_NF));
...
UTEST(m6502x, INC_DEC) {
    ...
    T(5 == step()); T(0x00 == mem[0x0033]); T(tf(M6502X_ZF));
    T(6 == step()); T(0x00 == mem[0x0043]); T(tf(M6502X_ZF));
    T(6 == step()); T(0x00 == mem[0x1000]); T(tf(M6502X_ZF));
    T(7 == step()); T(0x00 == mem[0x1010]); T(tf(M6502X_ZF));
}

UTEST(m6502x, ADC_SBC) {
    init();
    uint8_t prog[] = {
        0xA9, 0x01,         // LDA #$01
        0x85, 0x10,         // STA $10
    ...
    T(2 == step());  // CLC
    // ADC
    T(2 == step()); T(0xFD == R(A)); T(tf(M6502X_NF));
    T(3 == step()); T(0xFE == R(A)); T(tf(M6502X_NF));
    T(4 == step()); T(0xFF == R(A)); T(tf(M6502X_NF));
    T(4 == step()); T(0x00 == R(A)); T(tf(M6502X_ZF|M6502X_CF));
    T(5 == step()); T(0x02 == R(A)); T(tf(0));
    T(5 == step()); T(0x03 == R(A)); T(tf(0));
    // SBC
    T(5 == step()); T(0x01 == R(A)); T(tf(M6502X_CF));
    T(5 == step()); T(0x00 == R(A)); T(tf(M6502X_ZF|M6502X_CF));
    T(4 == step()); T(0xFF == R(A)); T(tf(M6502X_NF));
    T(4 == step()); T(0xFD == R(A)); T(tf(M6502X_NF|M6502X_CF));
    T(3 == step()); T(0xFC == R(A)); T(tf(M6502X_NF|M6502X_CF));
    T(2 == step()); T(0xFB == R(A)); T(tf(M6502X_NF|M6502X_CF));
}

UTEST(m6502x, CMP_CPX_CPY) {
    init();
...
UTEST(m6502x, ASL) {
    ...
    T(5 == step()); T(0x02 == mem[0x0010]); T(tf(M6502X_CF));
    T(6 == step()); T(0x04 == mem[0x0010]); T(tf(0));
    T(2 == step()); T(0x02 == R(A)); T(tf(M6502X_CF));
...
UTEST(m6502x, LSR) {
    ...
    T(2 == step()); T(0x01 == R(X));
    T(3 == step()); T(0x81 == mem[0x0010]);
    T(5 == step()); T(0x40 == mem[0x0010]); T(tf(M6502X_CF));
    T(6 == step()); T(0x20 == mem[0x0010]); T(tf(0));
    T(2 == step()); T(0x40 == R(A)); T(tf(M6502X_CF));
    T(2 == step()); T(0x20 == R(A)); T(tf(0));
}

UTEST(m6502x, ROR_ROL) {
    init();
    ...
    T(6 == step()); T(0x02 == mem[0x0010]); T(tf(M6502X_CF));
    T(5 == step()); T(0x81 == mem[0x0010]); T(tf(M6502X_NF));
    T(2 == step()); T(0x40 == R(A)); T(tf(M6502X_CF));
    T(2 == step()); T(0xA0 == R(A)); T(tf(M6502X_NF));
    T(2 == step()); T(0x40 == R(A)); T(tf(M6502X_CF));
    T(2 == step()); T(0x81 == R(A)); T(tf(M6502X_NF));
}
...
UTEST(m6502x, BIT) {
    ...
    T(3 == step()); T(tf(M6502X_ZF));
    T(3 == step()); T(tf(M6502X_NF));
    T(4 == step()); T(tf(M6502X_NF|M6502X_VF));
}

UTEST(m6502x, BNE_BEQ) {
    init();
    uint8_t prog[] = {
        0xA9, 0x10,         // LDA #$10
        0xC9, 0x10,         // CMP #$10
