...
items = [
    ...
    { 'type':'demo', 'title':'Ecole Buissonniere',  'system':'cpc',     'url':'cpc.html?disc=cpc/ecole_buissonniere.dsk&input=run%22ecole%0A', 'img':'cpc/ecole_buissonniere.jpg', 'note':'by MadRam/OVL (CPC)'},
    { 'type':'demo', 'title':'Demoizart (CPC)',     'system':'cpc',     'url':'cpc.html?disc=cpc/demoizart_cpc.dsk&input=run%22DIA%0A', 'img':'cpc/demoizart.jpg', 'note':'strobe warning!' },
    { 'type':'demo', 'title':"Logon's Run (CPC)",    'system':'cpc',     'url':'cpc.html?disc=cpc/logons_run_cpc.dsk&input=run%22logon%27s%0A', 'img':'cpc/logons_run.jpg', 'note':'by Overflow/Logon System' },
    { 'type':'demo', 'title':"YAP! (CPC)",          'system':'cpc',     'url':'cpc.html?disc=cpc/yet_another_plasma.dsk&input=run%22-yap%21%0A', 'img':'cpc/yet_another_plasma.jpg', 'note':'by Logon System' },
    { 'type':'demo', 'title':'Isometrikum (CPC)',   'system':'cpc',     'url':'cpc.html?disc=cpc/isometrikum.dsk&input=run%22isometri.kum%0A', 'img':'cpc/isometrikum.jpg', 'note':'by Vanity'},
    ...
    { 'type':'game', 'title':'Arkanoid RoD (CPC)',  'system':'cpc',     'url':'cpc.html?disc=cpc/arkanoid2_cpc.dsk&joystick=true&input=run%22arkanoid%0A', 'img':'cpc/arkanoid2_cpc.jpg', 'note':''},
    ...
    { 'type':'game', 'title':'Silkworm (CPC)',         'system':'cpc',  'url':'cpc.html?disc=cpc/silkworm_cpc.dsk&joystick=true&input=run%22disc%0A', 'img':'cpc/silkworm_cpc.jpg', 'note':'' },
    ...
    { 'type':'game', 'title':"Intern.Karate (CPC)", 'system':'cpc',     'url':'cpc.html?disc=cpc/intern_karate_cpc.dsk&joystick=true&input=run%22karate%0A', 'img':'cpc/intern_karate_cpc.jpg', 'note':''},
    { 'type':'game', 'title':"Intern.Karate+(CPC)", 'system':'cpc',     'url':'cpc.html?disc=cpc/intern_karate_plus_cpc.dsk&joystick=true&input=run%22IK%2B%0A', 'img':'cpc/intern_karate_plus_cpc.jpg', 'note':''},
    ...
    { 'type':'game', 'title':"Prince of Persia (CPC)", 'system':'cpc',  'url':'cpc.html?disc=cpc/prince_of_persia_cpc.dsk&joystick=true&input=run%22prince%0A', 'img':'cpc/prince_of_persia_cpc.jpg', 'note':'' },
