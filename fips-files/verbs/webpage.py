...
items = [
    ...
    { 'type':'demo', 'title':"Logon's Run 3D (CPC)",    'system':'cpc',     'url':'cpc.html?disc=cpc/logons_run_cpc.dsk&input=run%22logon%27s%0A', 'img':'cpc/logons_run.jpg', 'note':'by Overflow/Logon System' },
