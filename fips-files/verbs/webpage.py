...
items = [
    ...
    { 'type':'game', 'title':"Intern.Karate+(CPC)", 'system':'cpc',     'url':'cpc.html?file=cpc/intern_karate_plus_cpc.dsk&joystick=true&input=run%22IK%2B%0A', 'img':'cpc/intern_karate_plus_cpc.jpg', 'note':''},
